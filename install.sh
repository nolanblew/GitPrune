...
case $platform in
    ...
    msys*|mingw*|windowsnt|cygwin)
        ...
        powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "Invoke-RestMethod 'https://nolanblew.blob.core.windows.net/git-prune/install.ps1' | Invoke-Expression"
        ;;
esac
echo "Finished!"
